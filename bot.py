...
monitor_started = False  # ✅ ОБЯЗАТЕЛЬНО

def monitoring_loop():
    while True:
        time.sleep(60)
        # 👇 добавь здесь свою фоновую логику, если есть

def monitor_additional():
    while True:
        time.sleep(60)
        # 👇 добавь здесь свою вторую фоновую логику, если нужна
...
if __name__ == '__main__':
    bot.remove_webhook()
    time.sleep(1)
    bot.set_webhook(url=f'https://tablytsabot.onrender.com/{TOKEN}')
